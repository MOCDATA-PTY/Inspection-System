#!/usr/bin/env python
"""
OneDrive setup - Fixed for work email with personal Microsoft account
"""
import os
import sys
import django
...
def main():
    print("🔧 OneDrive Integration - Fixed Configuration")
    print("=" * 50)
    print("Account: anthony.penzes@fsa-pty.co.za")
    print("Note: Using personal Microsoft account endpoint (consumers)")
    ...
    # Generate authorization URL for personal Microsoft accounts
    auth_url = (
    ...
    print(f"✅ Callback route: /onedrive/callback/ is registered")
