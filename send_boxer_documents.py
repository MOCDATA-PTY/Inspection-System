...
def create_document_zip(documents, base_paths):
    ...
    zip_filename = f"Boxer_Superstore_Documents_{timestamp}.zip"
...
def send_email_with_attachment(zip_path, recipient_email):
    ...
    try:
        ...
        message['subject'] = f'Food Safety Agency - Boxer Superstore Documents - {datetime.now().strftime("%d/%m/%Y")}'
...
Please find attached the documentation pertaining to the inspection(s) conducted at Boxer Superstore - Manguzi 1 facility.

Inspection Overview:
- Client: Boxer Superstore - Manguzi 1
- Account Code: RE-COR-RAW-BXR-1550
- Commodities Inspected: RAW
- Inspection IDs: 8501, 8500
- Date: 2025-09-03

Commodity Breakdown:
RAW (Regulation R.1283 of 4 October 2019)
   - Status: Compliant
...
def main():
    ...
    inspection_ids = [8501, 8500]  # Boxer Superstore inspections
    recipient_email = "ethansevenster621@gmail.com"  # Email from the inspection data
