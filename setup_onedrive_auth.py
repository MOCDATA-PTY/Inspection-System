...
# Configure Django with proper encoding
import django.conf
django.conf.settings.configure(
    DEBUG=True,
    SECRET_KEY='temp-key-for-auth-setup',
    INSTALLED_APPS=[
    ...
    ONEDRIVE_REDIRECT_URI=os.environ.get('ONEDRIVE_REDIRECT_URI', 'http://localhost:8000/onedrive/callback'),
    ONEDRIVE_FOLDER=os.environ.get('ONEDRIVE_FOLDER', 'Legal-System-Media'),
...
def setup_onedrive_auth():
    ...
    try:
        ...
        # Generate authorization URL for organizational accounts
...
def main():
    ...
    if os.path.exists(token_file):
        ...
        if test_success:
            ...
            print("\nExisting tokens are invalid or expired")
